function [SE] = functionComputeSE_AP_downlink_analytical_noncoherent(R,gamma_kl,K,L,tau_c,tau_d,Pmax,mu,pilotIndex,rho)
    ...
    for k=1:K
        ...
        for i=1:K
            ...
            if i==k
                ...
                test3(k,i,l)=mu(i,l)*trace(gamma_kl(:,:,k,l))*trace(gamma_kl(:,:,i,l));
            end
        end
    end
end
