...
%%
LSFD_taup=zeros(length(FDT),K*nbrOfSetups);

for i=1:length(FDT)
LSFD_taup(i,:)=sort(reshape(SE_MR_analytical_tot_LSFD(i,:,:),[K*nbrOfSetups 1]));
