...
plot(sort(reshape(SE_MR_analytical_tot_LSFD_UN(1,1,:,:),[K*nbrOfSetups 1])),linspace(0,1,K*nbrOfSetups),'r-.','LineWidth',2);
plot(sort(reshape(SE_MR_analytical_tot_LSFD_UN(1,2,:,:),[K*nbrOfSetups 1])),linspace(0,1,K*nbrOfSetups),'b-.','LineWidth',2);
